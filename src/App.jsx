...
export default function App() {
  ...
  const [dm,setDm] = useState(()=>load("tc_darkmode",true));
  ...
  useEffect(()=>persist("tc_darkmode",dm),[dm]);
    ...
    <div dir={t.dir} style={{display:"flex",minHeight:"100vh",background:DARK.bg,fontFamily:t.font,color:DARK.text}}>
      <style>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0;}
        ...
        ::-webkit-scrollbar-thumb{background:${dm?DARK.accent:LIGHT.accent}66;border-radius:4px}
        ...
        .btn-primary{background:linear-gradient(135deg,${dm?DARK.accent:LIGHT.accent},${DARK.accentDark});color:#080b14;padding:8px 18px;font-size:13px}
        .btn-primary:hover{filter:brightness(1.1);box-shadow:0 4px 16px ${dm?DARK.accent:LIGHT.accent}44}
        .btn-secondary{background:${dm?DARK.card:LIGHT.card};color:${dm?DARK.muted:LIGHT.muted};padding:8px 14px;font-size:13px;border:1px solid ${dm?DARK.border:LIGHT.border}}
        .btn-secondary:hover{color:${dm?DARK.text:LIGHT.text};border-color:#3a4060}
        ...
        input,select{background:${dm?DARK.surface:LIGHT.surface};border:1px solid ${dm?DARK.border:LIGHT.border};color:${dm?DARK.text:LIGHT.text};border-radius:7px;padding:8px 12px;font-family:inherit;font-size:13px;width:100%;outline:none;transition:border .16s}
        input:focus,select:focus{border-color:${dm?DARK.accent:LIGHT.accent};box-shadow:0 0 0 3px ${dm?DARK.accent:LIGHT.accent}15}
        input::placeholder{color:#2e3a55}
        input[type=number]{-moz-appearance:textfield}
        input[type=checkbox]{width:auto;cursor:pointer;accent-color:${dm?DARK.accent:LIGHT.accent}}
        .lbl{font-size:11px;color:${dm?DARK.muted:LIGHT.muted};margin-bottom:4px;display:block;font-weight:600;text-transform:uppercase;letter-spacing:.04em}
        .err{color:#f87171;font-size:11px;margin-top:3px}
        .card{background:${dm?DARK.card:LIGHT.card};border:1px solid ${dm?DARK.border:LIGHT.border};border-radius:12px}
        ...
        .modal{background:${dm?DARK.card:LIGHT.card};border:1px solid ${dm?DARK.border:LIGHT.border};border-radius:16px;padding:24px;width:100%;max-width:520px;max-height:90vh;overflow-y:auto}
        ...
        th{padding:10px 13px;text-align:${lang==="ar"?"right":"left"};font-size:10px;font-weight:700;color:${dm?DARK.muted:LIGHT.muted};text-transform:uppercase;letter-spacing:.06em;background:${dm?DARK.surface:LIGHT.surface};white-space:nowrap}
        td{padding:10px 13px;border-bottom:1px solid ${dm?DARK.border:LIGHT.border}22;vertical-align:middle;font-size:13px}
        tr:last-child td{border-bottom:none}
        tr:hover td{background:${dm?DARK.surface:LIGHT.surface}77}
        ...
        .filter-btn{background:${dm?DARK.surface:LIGHT.surface};border:1px solid ${dm?DARK.border:LIGHT.border};color:${dm?DARK.muted:LIGHT.muted};padding:5px 12px;font-size:12px;border-radius:20px;cursor:pointer;font-family:inherit;font-weight:600;transition:all .14s}
        .filter-btn.active{background:${dm?DARK.accent:LIGHT.accent}20;border-color:${dm?DARK.accent:LIGHT.accent}66;color:${dm?DARK.accent:LIGHT.accent}}
        .divider{height:1px;background:${dm?DARK.border:LIGHT.border};margin:14px 0}
        .nav-item{display:flex;align-items:center;padding:9px 14px;border-radius:8px;cursor:pointer;font-size:13px;font-weight:600;color:${dm?DARK.muted:LIGHT.muted};transition:all .14s;border:none;background:transparent;font-family:inherit;width:100%;text-align:${lang==="ar"?"right":"left"}}
        .nav-item:hover{background:${dm?DARK.surface:LIGHT.surface};color:${dm?DARK.text:LIGHT.text}}
        .nav-item.active{background:${dm?DARK.accent:LIGHT.accent}18;color:${dm?DARK.accent:LIGHT.accent};border-${lang==="ar"?"right":"left"}:3px solid ${dm?DARK.accent:LIGHT.accent}}
        .perm-box{display:flex;gap:12px;align-items:center;padding:10px 14px;background:${dm?DARK.surface:LIGHT.surface};border-radius:8px;border:1px solid ${dm?DARK.border:LIGHT.border};margin-bottom:6px}
        .bar-bg{background:${dm?DARK.surface:LIGHT.surface};border-radius:3px;height:6px;flex:1}
        .bar-fill{height:6px;border-radius:3px;transition:width .4s ease}
        .section-hd{font-size:14px;font-weight:700;color:${dm?DARK.text:LIGHT.text};margin-bottom:12px;padding-bottom:8px;border-bottom:1px solid ${dm?DARK.border:LIGHT.border}}
        .top-n-btn{background:${dm?DARK.surface:LIGHT.surface};border:1px solid ${dm?DARK.border:LIGHT.border};color:${dm?DARK.muted:LIGHT.muted};padding:5px 12px;font-size:12px;border-radius:6px;cursor:pointer;font-family:inherit;font-weight:700;transition:all .14s}
        .top-n-btn.active{background:${dm?DARK.accent:LIGHT.accent}20;border-color:${dm?DARK.accent:LIGHT.accent}66;color:${dm?DARK.accent:LIGHT.accent}}
      `}</style>

      {/* SIDEBAR */}
      <div style={{width:sideOpen?220:0,minWidth:sideOpen?220:0,background:DARK.sidebar,borderRight:`1px solid ${dm?DARK.border:LIGHT.border}`,display:"flex",flexDirection:"column",transition:"all .2s",overflow:"hidden",position:"sticky",top:0,height:"100vh",flexShrink:0}}>
        ...
        <div style={{padding:"12px 8px",borderTop:`1px solid ${dm?DARK.border:LIGHT.border}`}}>
      ...
      <div style={{flex:1,display:"flex",flexDirection:"column",overflow:"hidden"}}>
        {/* TOPBAR */}
        <div style={{background:DARK.sidebar,borderBottom:`1px solid ${dm?DARK.border:LIGHT.border}`,padding:"10px 20px",display:"flex",alignItems:"center",justifyContent:"space-between",position:"sticky",top:0,zIndex:50}}>
          ...
          <div style={{display:"flex",gap:8,alignItems:"center"}}>
            ...
            >{dm?(lang==="ar"?"فاتح":"Light"):(lang==="ar"?"غامق":"Dark")}</button>
